(function(win, CLIType) {
  ...
  (function () {
    if (win.document.querySelector("#maps-clondalkin")) {
      win.inicializaMapa =  function() {
        var mapOptions = {
          zoom: 13,
          center: new google.maps.LatLng(53.32180, -6.3940),
          mapTypeId: google.maps.MapTypeId.ROADMAP
        }
        var map = new google.maps.Map(document.getElementById("maps-clondalkin"), mapOptions);
      };
